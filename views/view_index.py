...
class Index(object):
    def setupUi(self, Index):
        """
        This function makes de graphical structure of home page of our application
        ...
        Index.setFixedSize(720, 533)
        icon = QIcon()
        icon.addFile(u"./assets/ico.ico", QSize(), QIcon.Normal, QIcon.Off)
        icon.addFile(u"./assets/ico.ico", QSize(), QIcon.Normal, QIcon.On)
